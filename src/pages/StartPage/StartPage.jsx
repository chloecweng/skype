...
const StartPage = () => {
  ...
  const SCENES = {
    NORMAL: {
      initialHistory: [
        { sender: "HarborLine", text: "Hey.", time: getCurrentTime() },
      ],
      incomingScript: [],
    },
    SCENE_2: {
    ...
    SCENE_4: {
      initialHistory: [
        { sender: "August27", text: "hey uhh", time: getCurrentTime() },
        { sender: "August27", text: "r u arounfd", time: getCurrentTime() },
        {
          sender: "August27",
          text: "i thinmk i saw u??",
          time: getCurrentTime(),
        },
        { sender: "August27", text: "like just now", time: getCurrentTime() },
        {
          sender: "August27",
          text: "or am i mixign ppl",
          time: getCurrentTime(),
        },
        {
          sender: "August27",
          text: "im standin out frint",
          time: getCurrentTime(),
        },
        {
          sender: "August27",
          text: "frint of the place",
          time: getCurrentTime(),
        },
        { sender: "August27", text: "its dark tho", time: getCurrentTime() },
        {
          sender: "August27",
          text: "u were ther right",
          time: getCurrentTime(),
        },
        {
          sender: "August27",
          text: "i swearr u were",
          time: getCurrentTime(),
        },
        {
          sender: "August27",
        ...
        { sender: "August27", text: "then it movved", time: getCurrentTime() },
        { sender: "August27", text: "my eyes r bad", time: getCurrentTime() },
        {
          sender: "August27",
          text: "but not thta bad",
          time: getCurrentTime(),
        },
        { sender: "August27", text: "hello??", time: getCurrentTime() },
        { sender: "August27", text: "pls txt bak", time: getCurrentTime() },
        { sender: "August27", text: "dont be weird", time: getCurrentTime() },
        {
          sender: "August27",
          text: "im not tryin be",
          time: getCurrentTime(),
        },
        {
          sender: "August27",
          text: "i just wanna kno",
          time: getCurrentTime(),
        },
        { sender: "August27", text: "if that was u", time: getCurrentTime() },
        {
          sender: "August27",
          text: "bc u lookd right",
          time: getCurrentTime(),
        },
        { sender: "August27", text: "strait at me", time: getCurrentTime() },
        { sender: "August27", text: "like dead on", time: getCurrentTime() },
        { sender: "August27", text: "then u turnedd", time: getCurrentTime() },
        { sender: "August27", text: "an just", time: getCurrentTime() },
        { sender: "August27", text: "walkd off???", time: getCurrentTime() },
        { sender: "August27", text: "my brain cant", time: getCurrentTime() },
        { sender: "August27", text: "proccess that", time: getCurrentTime() },
        {
          sender: "August27",
          text: "did i do somethign",
          time: getCurrentTime(),
        },
        {
          sender: "August27",
          text: "say somethin wrong",
          time: getCurrentTime(),
        },
        {
          sender: "August27",
          text: "pls just say no",
          time: getCurrentTime(),
        },
        { sender: "August27", text: "or yes", time: getCurrentTime() },
        {
          sender: "August27",
          text: "anythign is bettr",
          time: getCurrentTime(),
        },
        { sender: "August27", text: "than this", time: getCurrentTime() },
        { sender: "August27", text: "im starin at", time: getCurrentTime() },
        { sender: "August27", text: "the door still", time: getCurrentTime() },
        {
          sender: "August27",
          text: "peopl walk past",
          time: getCurrentTime(),
        },
        { sender: "August27", text: "none of them u", time: getCurrentTime() },
        {
          sender: "August27",
          text: "i feel so stupdi",
          time: getCurrentTime(),
        },
        {
          sender: "August27",
          text: "like reall stupid",
          time: getCurrentTime(),
        },
        {
          sender: "August27",
          text: "i thout we were",
          time: getCurrentTime(),
        },
        { sender: "August27", text: "cool at least", time: getCurrentTime() },
        { sender: "August27", text: "freinds maybe", time: getCurrentTime() },
        { sender: "August27", text: "u said freinds", time: getCurrentTime() },
        {
          sender: "August27",
          text: "was that fake tho",
          time: getCurrentTime(),
        },
        {
          sender: "August27",
          text: "bc it felt real",
          time: getCurrentTime(),
        },
        { sender: "August27", text: "to me i guess", time: getCurrentTime() },
        {
          sender: "August27",
          text: "my hands r shakn",
          time: getCurrentTime(),
        },
        { sender: "August27", text: "im typign bad", time: getCurrentTime() },
        { sender: "August27", text: "srry", time: getCurrentTime() },
        {
          sender: "August27",
          text: "im just confused",
          time: getCurrentTime(),
        },
        { sender: "August27", text: "and hurt a bit", time: getCurrentTime() },
        {
          sender: "August27",
          text: "pls dont ignroe",
          time: getCurrentTime(),
        },
        { sender: "August27", text: "me like this", time: getCurrentTime() },
        { sender: "August27", text: "i paidd u", time: getCurrentTime() },
        { sender: "August27", text: "remmebr", time: getCurrentTime() },
        {
          sender: "August27",
          text: "u said come bak",
          time: getCurrentTime(),
        },
        { sender: "August27", text: "i beleived u", time: getCurrentTime() },
        { sender: "August27", text: "im still here", time: getCurrentTime() },
        { sender: "August27", text: "waitin", time: getCurrentTime() },
        { sender: "August27", text: "loking arond", time: getCurrentTime() },
        { sender: "August27", text: "pls", time: getCurrentTime() },
        { sender: "August27", text: "say somethign", time: getCurrentTime() },
        { sender: "August27", text: "anything", time: getCurrentTime() },
        { sender: "August27", text: "dont do this", time: getCurrentTime() },
        { sender: "August27", text: "not like this", time: getCurrentTime() },
        { sender: "August27", text: "i miss u", time: getCurrentTime() },
        { sender: "August27", text: "even rn", time: getCurrentTime() },
        { sender: "August27", text: "im right here", time: getCurrentTime() },
        { sender: "August27", text: "Wwere di u go/", time: getCurrentTime() },
        {
          sender: "August27",
        ...
        { sender: "August27", text: "please.", time: getCurrentTime() },
        { sender: "August27", text: "good night", time: getCurrentTime() },
        {
          sender: "August27",
