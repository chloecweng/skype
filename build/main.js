...
const createWindow = () => {
  const mainWindow = new require$$3$1.BrowserWindow({
    ...
    height: 682,
    useContentSize: true,
    // Ensures the 1158x682 is the actual drawing area
    resizable: false,
    // Keeps the UI perfect for the camera
    frame: false,
    // Removes the standard window border
    transparent: true,
    // Allows our CSS Aero glass effect to work
    webPreferences: {
